...
(function timer(){
  ...
  document.getElementById("about_self").disabled = true;
...
<input type="text" class="form-control input-sm" name="uname" id="uname"  onkeypress="return blockSpecialChar(event)" required placeholder="Name" />
...
<input type="email" class="form-control" name="e_mail" id="e_mail" required placeholder="Enter Email here" required>
</div>
...
<div class="form-group">
		...
		<input type="date" class="form-control" name="dob" id="dob" value="<?php echo $dob;?>" required><br><br>
											
<div class="form-row">
	About Yourself:<br><br>
<textarea rows = "7" cols = "50" name = "about_self" id="about_self" style="text-align:left-side;">
</textarea>
